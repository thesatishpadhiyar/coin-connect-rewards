...
import {
  LayoutDashboard, Building2, Users, ShoppingBag, Gift, Wallet,
...
const navItems = [
  ...
  { to: "/admin/wallet-transactions", icon: Wallet, label: "Transactions" },
      ...
      <div className="flex flex-1 flex-col">
        <header className="sticky top-0 z-40 border-b border-border bg-card/95 backdrop-blur-lg px-4 py-3 lg:px-6">
          <div className="flex items-center justify-between">
            ...
            <Button variant="ghost" size="icon" onClick={signOut} className="lg:hidden" title="Sign out">
              <LogOut className="h-4 w-4" />
            </Button>
          </div>
        </header>
